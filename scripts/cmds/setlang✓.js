...
module.exports = {
	...
	langs: {
		...
		en: {
			setLangForAll: "تغيير لغة البوت إلى: %1",
			setLangForCurrent: "Set default language for current chat: %1",
			noPermission: "حبي 🌝 كيوت 🙃 ماعدك صلاحية إنقلع 😑🗿",
			langNotFound: "لا توجد لغة: %1"
		}
	},
