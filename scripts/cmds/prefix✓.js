...
module.exports = {
	config: {
		...
		countDown: 5,
		role: 0,
		shortDescription: "مالك دخل خاص ب المطور ✅",
	...
	langs: {
		...
		en: {
			...
			onlyAdmin: "فقط الہٰشہٰامہٰي ﮯٰ يمكنه ⚜️",
			confirmGlobal: "سويي رياكشن إذا متأكد ⚜️🌟",
			confirmThisThread: "ضع رياكشن إذا كنت متأكد ⚜️🌟",
