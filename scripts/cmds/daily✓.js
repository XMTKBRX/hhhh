...
module.exports = {
	config: {
		...
		longDescription: {
			vi: "Nhận quà hàng ngày",
			en: "يعطيك نقاط تزيد مستواك و نقود"
		},
		category: "ألعاب",
		guide: {
	...
	langs: {
		...
		en: {
			...
			saturday: "السبت",
			sunday: "الأحد",
			alreadyReceived: "أخذت الهدية ليش الطمع 😐",
			received: "لقد حصلت على %1 دولار و %2 نقطة"
		}
	},
						...
						i == 5 ? getLang("friday") :
							i == 4 ? getLang("thursday") :
								i == 3 ? getLang("wednesday") :
									i == 2 ? getLang("tuesday") :
										getLang("monday");
				msg += `${day}: ${getCoin} دولار, ${getExp} نقطة\n`;
			}
